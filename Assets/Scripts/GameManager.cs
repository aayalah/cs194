...
public class GameManager : MonoBehaviour {
	...
	public void changeCameraPosition(int player) {
		if (player == 0) {
			Vector3 pos = new Vector3(7.0146f, 11.532f, -4.162f);
			camera.transform.position = pos;
			camera.transform.rotation =  Quaternion.Euler(45f, 1f, 1.1319f);
		} else if (player == 1) {
			Vector3 pos = new Vector3(7.7886f, 13.082f, 24.784f);
			camera.transform.position = pos;
			camera.transform.rotation = Quaternion.Euler(40, 175, 355);
		}
